package com.kennen.springbootcache;

import com.kennen.springbootcache.dao.entity.User;
import com.kennen.springbootcache.service.UserService;
...
//        assertEquals(list.size(), 2);
		...
		User user9 = userService.getById1(id); // 第3次访问，使用另一个获取方法
		assertEquals(user4.getPassword(), "admin");
